...
class InteractiveBrokersWrapper(EWrapper):
    ...
    def tickByTickBidAsk(
        ...
        zmq_msg = (
            1,
            1,
            (self.bkr, product.exchange, str(product), bids, asks, time, extra_data),
        )
        self._zmq.send(*zmq_msg)
    ...
    def tickByTickAllLast(
        ...
        zmq_msg = (
            1,
            2,
            (self.bkr, product.exchange, str(product), price, size, time, extra_data),
        )
        self._zmq.send(*zmq_msg)
    ...
    def realtimeBar(
        ...
        extra_data = {"wap": wap, "count": count}
        zmq_msg = (
            1,
            3,
            (
