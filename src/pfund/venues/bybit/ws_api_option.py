...
from pfund.brokers.crypto.exchanges.bybit.ws_api_base import BybitBaseWebSocketAPI
...
class BybitOptionWebSocketAPI(BybitBaseWebSocketAPI):
    CATEGORY: ClassVar[BybitProduct.Category] = BybitProduct.Category.OPTION
