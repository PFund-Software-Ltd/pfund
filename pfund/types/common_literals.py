...
tSUPPORTED_TRADING_VENUES = Literal['IB', 'BYBIT']
tSUPPORTED_BROKERS = Literal['CRYPTO', 'DEFI', 'IB']
...
tSUPPORTED_TRADFI_PRODUCT_TYPES = Literal['STK', 'FUT', 'OPT', 'CASH', 'CRYPTO', 'BOND', 'FUND', 'CMDTY']
