...
class TradeMixin:
    ...
    def dataset(self: BaseStrategy | BaseModel) -> Dataset:
        return self._data_tool.dataset
    ...
    def create_logger(self: BaseStrategy | BaseModel):
    ...
    def _add_consumer(self: BaseStrategy | BaseModel, consumer: BaseStrategy | BaseModel):
