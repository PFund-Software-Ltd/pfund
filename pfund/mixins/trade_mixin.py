...
class TradeMixin:
    ...
    def _setup_logging(self: BaseStrategy | BaseModel, logging_configurator_or_config: LoggingDictConfigurator | dict):
        ...
        if self._run_mode == RunMode.REMOTE:
            from pfund._logging.config import LoggingDictConfigurator
            # set up strategy's own logging when running in remote mode
            logging_config = logging_configurator_or_config
            ...
            logging_configurator = logging_configurator_or_config
    ...
    @property
    def resolution(self: BaseStrategy | BaseModel) -> Resolution | None:
    ...
    @property
    def run_mode(self: BaseStrategy | BaseModel) -> RunMode:
        return self._run_mode
    
    def get_run_mode(self: BaseStrategy | BaseModel) -> RunMode:
        return self._run_mode
    
    def _set_run_mode(self: BaseStrategy | BaseModel, run_mode: RunMode):
