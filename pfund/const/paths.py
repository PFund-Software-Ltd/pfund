...
STRATEGY_PATH = DATA_PATH / 'pfund_hub' / 'strategies'
MODEL_PATH = DATA_PATH / 'pfund_hub' / 'models'
FEATURE_PATH = DATA_PATH / 'pfund_hub' / 'features'
INDICATOR_PATH = DATA_PATH / 'pfund_hub' / 'indicators'
