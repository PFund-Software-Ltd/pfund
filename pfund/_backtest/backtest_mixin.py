...
class BacktestMixin:
    ...
    def add_data(
        ...
        **product_specs
        ...
        #     '''
        #     extra_resolutions = data_config.extra_resolutions
        ...
        #     extra_resolutions = data_config.extra_resolutions
        #     primary_resolution = self._resolution
        #     skip_first_bar = data_config.skip_first_bar
        ...
        if use_tick_or_quote:
            cprint('WARNING: tick data and quote data will be ignored in backtesting', style=TextStyle.BOLD + RichColor.RED)
        return datas
