...
def SimulatedBrokerFactory(broker: str) -> type[SimulatedBroker]:
...
class SimulatedBroker(BaseBroker):
    _DEFAULT_INITIAL_BALANCES = {'BTC': 10, 'ETH': 100, 'USD': 1_000_000}
    ...
    def _create_account(self, name: str, **kwargs):
